# تحفة الأطفال في تجويد القرآن — Sulaymān al-Jamzūrī (1198 AH)

Source: Arabic Wikisource (ar.wikisource.org/wiki/تحفة_الأطفال), fetched 2026-07-11.
Line numbers are this file's canonical citation targets
(`{ text: "tuhfah", line: N }`). Hemistichs separated by ***.
